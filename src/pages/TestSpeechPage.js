...
export default function TestSpeechPage() {
  ...
  return (
    <div className="container">
      ...
      <main style={{ padding: '20px', display: "flex", flexDirection: "column", rowGap: "1rem" }}>
        <Text />
        ...
        <div>
          <p>Speech Status: <strong>{speechStatus}</strong></p>
          <p>Is In Queue: <strong>{isInQueue ? 'Yes' : 'No'}</strong></p>
        </div>
      </main>
    </div>
  );
